                                            ...
                                            foreach ($cats as $cat) {
                                                echo "<div class='container'>";
                                                    echo '<div class="row">';
                                                        ...
                                                        echo "<p>{$cat['Cat_description']}</p>"; 
                                                        echo "<p>{$cat['Cat_parent']}</p>"; 
                                                        echo '</div>';
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 offset-lg-3">
                        <form action="?do=insert" method="POST">
                            ...
                            <div class="form-group">
                                <input type="text" name="category_desc" class="form-control" placeholder="Description" required="required" autocomplete="off">
                            </div>
                            ...
                            <div class="form-group">
                                <label>Visibility</label>
                                 <div class="input-group">
                                    <div>
                                        <input type="radio" name="cat_visibility" id="cat_visibility" value="0" checked>
                                        <label for="">No</label>
                                    </div> 
                                    <div>
                                        <input type="radio" name="cat_visibility" id="cat_visibility" value="1" >
                                        <label for="">Yes</label>
                                    </div>
                                 </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label>Allow Comment</label>
                                 <div class="input-group">
                                    <div>
                                        <input type="radio" name="cat_commenting" id="cat_com_yes" value="0" checked>
                                        <label for="">No</label>
                                    </div> 
                                    <div>
                                        <input type="radio" name="cat_commenting" id="cat_com_no" value="1" >
                                        <label for="">Yes</label>
                                    </div>
                                 </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label>Allow Ads</label>
                                 <div class="input-group">
                                    <div>
                                        <input type="radio" name="category_ads" id="cat_ads_yes" value="0" checked>
                                        <label for="">No</label>
                                    </div> 
                                    <div>
                                        <input type="radio" name="category_ads" id="cat_ads_no" value="1" >
                                        <label for="">Yes</label>
                                    </div>
                                 </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <form action="?do=update" method="POST">
                                ...
                                <!-- Category Description Field Starts -->
                                <div class="form-group">
                                    <input type="text" name="category_desc" class="form-control" value="<?= $cat['Cat_description'];?>" required="required" autocomplete="off">
                                </div>
                                <!-- Category Description Field Ends -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div>
                                            <input type="radio" name="cat_visibility" id="cat_visibility"  <?php if($cat['Cat_visibility'] == 0 ){ echo "checked"; } ?> >
                                            <label for="">No</label>
                                        </div> 
                                        <div>
                                            <input type="radio" name="cat_visibility" id="cat_visibility" value="1" <?php if($cat['Cat_visibility'] == 1 ){ echo "checked"; } ?> >
                                            <label for="">Yes</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div>
                                            <input type="radio" name="cat_commenting" id="cat_com_yes" <?php if($cat['Cat_comments'] == 0 ){ echo "checked"; } ?> >
                                            <label for="">No</label>
                                        </div> 
                                        <div>
                                            <input type="radio" name="cat_commenting" id="cat_com_no" value="1" <?php if($cat['Cat_comments'] == 1 ){ echo "checked"; } ?> >
                                            <label for="">Yes</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div>
                                            <input type="radio" name="category_ads" id="cat_ads_yes"  <?php if($cat['Cat_ads'] == 0 ){ echo "checked"; } ?> >
                                            <label for="">No</label>
                                        </div> 
                                        <div>
                                            <input type="radio" name="category_ads" id="cat_ads_no" value="1" <?php if($cat['Cat_ads'] == 0 ){ echo "checked"; } ?> >
                                            <label for="">Yes</label>
                                        </div>
                                    </div>
                                </div>
...
<?php   }// Update Page Ends here
            ...
            echo "WELCOME TO THE CATEGORY PAGE - DELETE";
